...
/** GET /api/equipment — tất cả thiết bị (admin) */
...
/** GET /api/equipment/room/:roomId — thiết bị của một phòng */
...
/** DELETE /api/equipment/:id — xoá thiết bị (admin) */
const deleteEquipment = async (req, res) => {
  try {
    const equipmentID = parseInt(req.params.id);
    await execute(`UPDATE Equipment SET Visible=0 WHERE EquipmentID=@equipmentID`, { equipmentID });
